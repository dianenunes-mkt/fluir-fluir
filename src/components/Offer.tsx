  ...
  return (
    <section className="py-24 px-6 bg-background text-foreground">
      <div className="container mx-auto max-w-5xl">
        ...
        <div className="bg-primary/5 backdrop-blur-sm rounded-3xl p-8 md:p-12 mb-12 animate-slide-up border border-primary/10">
        ...
        <div className="text-center animate-slide-up">
          <Button 
            size="lg"
            className="bg-primary hover:bg-primary/90 text-primary-foreground text-xl px-12 py-8 rounded-full transition-all hover:scale-105 shadow-2xl"
          >
