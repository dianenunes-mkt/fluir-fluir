import { Building2, Briefcase, Users, TrendingUp, BarChart3, MessageSquare } from "lucide-react";
      ...
      <div className="container mx-auto max-w-6xl">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6 max-w-5xl mx-auto">
          {audiences.map((audience, index) => (
            <div 
              key={index}
              className="flex items-center gap-4 p-6 bg-primary/5 backdrop-blur-sm rounded-2xl border border-primary/10 hover:bg-primary/10 transition-all animate-slide-up"
